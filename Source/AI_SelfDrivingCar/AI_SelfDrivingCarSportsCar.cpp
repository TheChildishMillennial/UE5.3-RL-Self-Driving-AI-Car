...
#include "AI_SelfDrivingCarSportsCar.h"
...
AAI_SelfDrivingCarSportsCar::AAI_SelfDrivingCarSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAI_SelfDrivingCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAI_SelfDrivingCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAI_SelfDrivingCarSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAI_SelfDrivingCarSportsWheelRear::StaticClass();
