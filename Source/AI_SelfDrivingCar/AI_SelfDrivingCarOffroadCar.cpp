...
#include "AI_SelfDrivingCarOffroadCar.h"
#include "AI_SelfDrivingCarOffroadWheelFront.h"
...
AAI_SelfDrivingCarOffroadCar::AAI_SelfDrivingCarOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAI_SelfDrivingCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAI_SelfDrivingCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAI_SelfDrivingCarOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAI_SelfDrivingCarOffroadWheelRear::StaticClass();
